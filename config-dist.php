...
$CFG->dbhost    = '34.100.230.134';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'test-moodle';     // database name, eg moodle
$CFG->dbuser    = 'postgres';   // your database username
$CFG->dbpass    = 'anantha';   // your database password
...
$CFG->wwwroot   = 'http://34.93.240.66/moodle';
